...
### Awards analysis
To proxy peers' recognition, we will use awards, in particular Oscars, as a success outcome. Supervised learning methods will help us predict success from features included in the dataset and highlight the important ones for getting an Oscar.
